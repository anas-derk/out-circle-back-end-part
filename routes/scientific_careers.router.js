...
scientific_careers_router.post("/add-new-user", upload.single("user_file"), scientific_careers_controller.post_scientific_careers_account);
...
scientific_careers_router.put("/update-scientific-career-user-info/:scientific_career_id", upload.single("user_file"), scientific_careers_controller.put_scientific_career_info);
